...
char times[30] = {0}; //global string for the current time stamp, it will be updated whenever executed getCurrentTimeMsStr(ts)
...
//     strftime(buf, sizeof(buf), "%Y-%m-%dT%H:%M:%S", &times);
